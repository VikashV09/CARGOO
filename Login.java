...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\subaash\\Desktop\\must.jpg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user.equals("Vikash") && pass.equals("123"))
        {
            Main m = new Main();
            this.hide();
            m.setVisible(true);
        }
        else if(user.equals("Ivan") && pass.equals("123"))
        {
            Main m = new Main();
            this.hide();
            m.setVisible(true);
